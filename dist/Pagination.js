jQuery.extend({
	...
	PaginationBody: "<div class='ui right floated blue inverted borderless large menu' id='Pagination'>"
	...
	Page: function($AfterSelector, TotalPageNums, PageNum, URL, ErrorFunc, SuccessFunc) {
		...
		// 设置首尾页点击事件
		$LeftItem.bind('click', function(){$.requestPage($AfterSelector, TotalPageNums, 1, URL, ErrorFunc, SuccessFunc)});
		$RightItem.bind('click', function(){$.requestPage($AfterSelector, TotalPageNums, TotalPageNums, URL, ErrorFunc, SuccessFunc)});
